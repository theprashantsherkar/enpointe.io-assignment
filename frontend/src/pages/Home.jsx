...
function Home() {
    return (
        <div>
            ...
            <div className='flex items-center justify-center w-full flex-col h-screen gap-16 bg-gray-200'>
                ...
                <div className='flex items-center justify-center gap-3 bg-gray-200 w-full'>
