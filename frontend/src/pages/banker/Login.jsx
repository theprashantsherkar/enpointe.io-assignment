        ...
        <>
            ...
            <div className='flex items-center justify-center w-full h-screen '>
                <div className='flex flex-col items-center justify-center w-1/3 h-1/2 bg-white shadow-lg rounded-lg p-5 gap-5'>
                    <h1 className='text-3xl font-bold mb-4 flex items-center justify-center gap-3'><ArrowBackIcon className='hover:cursor-pointer rounded-full border border-black scale-150' onClick={() => navigate(-1)} />Banker's Login</h1>
